...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-brown-50 via-white to-brown-100 px-4">
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="rounded-3xl border border-brown-100 bg-white/80 shadow-2xl backdrop-blur-md px-8 py-10">
          ...
          <div className="mb-8 text-center">
            <Link href="/" className="inline-block">
              <h1 className="text-4xl font-extrabold tracking-tight text-brown-900">
                Quicky
              </h1>
            </Link>
          ...
          >
            {googleLoading ? (
              <svg className="h-4 w-4 animate-spin text-brown-500" viewBox="0 0 24 24" fill="none">
                <circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4" />
                <path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8v8H4z" />
              </svg>
            ) : (
          ...
          <p className="mt-6 text-center text-xs text-brown-400">
            ...
            <Link href="/TermsandConditions" className="text-brown-600 underline hover:text-brown-900">
              Terms
            </Link>{" "}
            &amp;{" "}
            <Link href="/RefundandCancellation" className="text-brown-600 underline hover:text-brown-900">
              Refund Policy
            </Link>
          </p>
        </div>
        ...
        <div className="mt-5 text-center">
          <Link
            href="/"
            className="inline-flex items-center gap-1.5 text-sm text-brown-500 hover:text-brown-900 transition"
          >
